      ...
      <Main>
        ...
        <Maps>
          <div className="google-map-code">
            ...
            <H3>VR-City Zürich <br/> <a href={'https://vrcity.ch'} style={{textDecoration:"none", color: "#ffffff", fontSize: "1rem"}} target="_blank">Website</a></H3>
            <iframe
          ...
          <br />
          <div className="google-map-code">
            <H3>VR-Center Basel <br/> <a href={'https://vr-centerbasel.ch'} style={{textDecoration:"none", color: "#ffffff", fontSize: "1rem"}} target="_blank">Website</a></H3>
            <iframe
          ...
          <br />
          <div className="google-map-code">
            <H3>Fusion Arena Bern <br/> <a href={'https://bern.fusionarena.ch/'} style={{textDecoration:"none", color: "#ffffff", fontSize: "1rem"}} target="_blank">Website</a> </H3>
            <iframe
          ...
          <P>Falls das Spiel inn deinem lieblings VR-Center nicht erhältlich ist, lass es uns via Kontaktformular wissen. <br/>Gerne schauen wir mit dem VR-Center, das sie uns in ihre Sortiment aufnehmen.</P>
        </Maps>
        <br />
        </Parallax>
      </Main>
