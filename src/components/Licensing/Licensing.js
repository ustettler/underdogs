  ...
  return (
    <>
      <Main>
        ...
        <P>
          Falls du ein VR-Center hast und unser Spiel gerne in dein Angebot
          aufnehmen möchtest, <br />
          nehme via Kontaktformular mit uns Kontakt auf oder rufe uns an.
        </P>
        <Requirement>
          <H3>
